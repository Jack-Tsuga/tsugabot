...
def shoplist():
	...
	for shop in shops:
		list += "<tr><td>"+str(shop['id'])+"</td><td>"+shop['name']+"</td><td>"+shop['yomi']+"</td><td>"+shop['address']+"</td><td>"+shop['image']+"</td><td>"+shop['staff']+"</td><td>"+shop['tel']+"</td><td>"+shop['email']+"</td></tr>"
	list += "</table>"
	s
	ql = 'SELECT * FROM shops'
